...
if __name__ == "__main__":
    ...
    for angle in sweep:
        ...
        if USE_IBM_HARDWARE:
            output_file = f'leggett_results_ibm_midcircuit_twentyfour_{BACKEND_NAME}_{timestamp}.json'
        elif USE_NOISE_MODEL:
            output_file = f'leggett_results_ibm_midcircuit_twentyfour_noise_{args.noise_model}_{timestamp}.json'
        else:
            output_file = f'leggett_results_ibm_midcircuit_twentyfour_ideal_sim_{timestamp}.json'

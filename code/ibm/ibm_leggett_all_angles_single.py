...
if __name__ == "__main__":
    ...
    if USE_IBM_HARDWARE:
        output_file = f'leggett_results_ibm_all_angles_{BACKEND_NAME}_{timestamp}.json'
    elif USE_NOISE_MODEL:
        output_file = f'leggett_results_ibm_all_angles_noise_{args.noise_model}_{timestamp}.json'
    else:
        output_file = f'leggett_results_ibm_all_angles_ideal_sim_{timestamp}.json'

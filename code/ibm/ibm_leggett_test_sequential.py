...
def main():
    ...
    if output_file is None:
        if use_ibm:
            output_file = f"leggett_results_ibm_{backend_name}_sequential_24qb.json"
        elif use_noise_model:
            output_file = f"leggett_results_ibm_{backend_name}_NOISE_MODEL_24qb.json"
        else:
            output_file = "leggett_results_ibm_sequential_SIM_noiseless_24qb.json"

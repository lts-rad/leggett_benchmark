...
if __name__ == "__main__":
    ...
    if USE_IBM_HARDWARE:
        output_file = f'leggett_results_azure_h2_{timestamp}.json'
    elif USE_NOISE_MODEL:
        output_file = f'leggett_results_azure_h2_noise_{args.noise_model}_{timestamp}.json'
    else:
        output_file = f'leggett_results_azure_h2_ideal_sim_{timestamp}.json'

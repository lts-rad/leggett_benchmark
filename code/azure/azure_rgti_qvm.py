...
def main():
    ...
    if output_file is None:
        if use_azure:
            output_file = f"leggett_results_azure_sim_h2-1_sequential_24qb.json"
        elif use_noise_model:
            output_file = f"leggett_results_azure_h2_NOISE_MODEL_24qb.json"
        else:
            output_file = "leggett_results_azure_h2_SIM_noiseless_24qb.json"

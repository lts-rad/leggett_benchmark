...
#!/usr/bin/env python3
"""
Create radar plot for Leggett correlation measurements from 12qb TOP6 layout.
"""
...
# Load results
with open('leggett_results_ibm_ibm_pittsburgh_sequential_12qb_TOP6.json', 'r') as f:
    results = json.load(f)
...
title += f'IBM Pittsburgh - 12 Qubits (6 pairs) - TOP 6 Layout'
...
# Save
output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'plots', 'pittsburgh_12qb_TOP6_phi_30.png')

...
def main():
    ...
    if output_file is None:
        if use_ibm:
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', f'leggett_results_ibm_{backend_name}_sequential_12qb_BEST_LAYOUT.json')
        elif use_noise_model:
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', f'leggett_results_ibm_{backend_name}_NOISE_MODEL_12qb_BEST_LAYOUT.json')
        else:
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'leggett_results_ibm_sequential_SIM_noiseless_12qb_BEST_LAYOUT.json')

    print("="*70)
    print("LEGGETT INEQUALITY TEST: Sequential Jobs with 12 Qubits (IBM Quantum)")
    print("USING BEST LAYOUT FROM QUBIT PAIR SCAN")
    print("="*70)
    print(f"\nConfiguration:")
    if use_ibm:
    ...
    print(f"  Layout: BEST from scan - pairs (30,29), (86,87), (110,111), (13,14), (112,113), (153,152)")

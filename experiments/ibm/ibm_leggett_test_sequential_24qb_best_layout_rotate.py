...
def main():
    ...
    if output_file is None:
        if use_ibm:
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', f'leggett_results_ibm_{backend_name}_sequential_24qb_BEST_LAYOUT_rotated_10k.json')
        elif use_noise_model:
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', f'leggett_results_ibm_{backend_name}_NOISE_MODEL_24qb_BEST_LAYOUT_rotated_10k.json')
        else:
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'leggett_results_ibm_sequential_SIM_noiseless_24qb_BEST_LAYOUT_rotated_10k.json')
    ...
    print(f"  Layout: BEST 12 pairs - (67,68), (29,30), (54,55), (93,92), (109,110), (2,3), (13,14), (112,113), (153,152), (75,74), (94,95), (107,97)")

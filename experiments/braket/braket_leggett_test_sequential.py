...
Each job measures 12 correlations (6 for +phi, 6 for -phi) using 12 singlet pairs = 24 qubits.
"""
...
def main():
    ...
    output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'leggett_results_sequential.json')
    ...
    print(f"  Circuit size: 24 qubits (12 singlet pairs, testing +/- phi)")
    ...
    print(f"\nAll results:")
    print(f"{'Angle':>8} {'L3(exp)':>10} {'L3(th)':>10} {'Bound':>10} {'D(exp-th)':>12} {'Status':>12}")
    print("-"*70)
